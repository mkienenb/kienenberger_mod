...
//			.newSimpleChannel(RainbowWorldMain.MODID);
//
//	/**
...
//				OpenGuiMessage.OpenGuiMessageHandler.class,
//				OpenGuiMessage.class, Side.SERVER);
//		PacketDispatcher.registerMessage(
//				SyncPlayerPropsMessage.SyncPlayerPropsMessageHandler.class,
//				SyncPlayerPropsMessage.class, Side.CLIENT);
//
...
//	 */
//	private static final void registerMessage(Class handlerClass,
//			Class messageClass, Side side) {
//		PacketDispatcher.dispatcher.registerMessage(handlerClass, messageClass,
//				packetId++, side);
//	}
//
//	// ========================================================//
...
//		PacketDispatcher.sendToAllAround(message,
//				player.worldObj.provider.getDimension(), player.posX,
//
