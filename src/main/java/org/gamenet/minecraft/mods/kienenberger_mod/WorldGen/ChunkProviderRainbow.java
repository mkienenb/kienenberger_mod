...
public class ChunkProviderRainbow implements IChunkGenerator
{
    protected static final IBlockState STONE = Blocks.STONE.getDefaultState();
    protected static final IBlockState GRACEBLOCK = ModBlocks.graceBlock.getDefaultState();
    ...
    public ChunkProviderRainbow(World worldIn, long seed, boolean mapFeaturesEnabledIn, String p_i46668_5_)
    {
        {
	...
	public Chunk provideChunk(int x, int z)
    {
        ...
        ChunkPrimerModified chunkprimer = new ChunkPrimerModified();
        ...
        chunkprimer.setFinishedBiomes(true);
