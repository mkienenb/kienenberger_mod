package org.gamenet.minecraft.mods.kienenberger_mod.client.model;
...
public class ModelDiamondGolem extends ModelBase
{
    ...
    /** The left leg model for the Diamond Golem. */
    public ModelRenderer ironGolemLeftLeg;
    /** The right leg model for the Diamond Golem. */
    ...
    public ModelDiamondGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelDiamondGolem(float p_i46362_1_, float p_i46362_2_)
    {
    ...
    {
        EntityDiamondGolem entityirongolem = (EntityDiamondGolem)entitylivingbaseIn;
